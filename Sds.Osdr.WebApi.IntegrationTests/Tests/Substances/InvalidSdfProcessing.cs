...
namespace Sds.Osdr.WebApi.IntegrationTests
{
    public class InvalidSdfProcessingFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "test_solubility.sdf", new Dictionary<string, object>() { { "parentId", harness.JohnId } }).Result;
