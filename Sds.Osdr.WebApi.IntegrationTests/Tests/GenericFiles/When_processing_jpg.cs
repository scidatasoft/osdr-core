...
namespace Sds.Osdr.WebApi.IntegrationTests
{
    public class UploadJpgFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "computer-humor-computer-science.jpg", new Dictionary<string, object>() { { "parentId", harness.JohnId } }).Result;
    ...
    public class UploadJpg : OsdrWebTest, IClassFixture<UploadJpgFixture>
    {
        private Guid BlobId { get; set; }
        private Guid FileId { get; set; }

        public UploadJpg(OsdrWebTestHarness fixture, ITestOutputHelper output, UploadJpgFixture initFixture) : base(fixture, output)
        {
        ...
        public async Task JpgUpload_ValidJpg_GenerateExpectedFileEntity()
        {
        ...
        [Fact, WebApiTrait(TraitGroup.All, TraitGroup.Generic)]
        public async Task JpgUpload_ValidJpg_GenerateExpectedFileNode()
        {
            var blobInfo = await BlobStorage.GetFileInfo(BlobId, JohnId.ToString());
            blobInfo.Should().NotBeNull();
        ...
        [Fact, WebApiTrait(TraitGroup.All, TraitGroup.Generic)]
        public async Task JpgUpload_ValidJpg_GenerateExpectedRecordNodesOnlyEmpty()
        {
