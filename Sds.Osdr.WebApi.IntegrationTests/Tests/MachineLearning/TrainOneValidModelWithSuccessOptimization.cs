...
namespace Sds.Osdr.WebApi.IntegrationTests
{
    ...
    public class TrainOneValidModelWithSuccessOptimization : OsdrWebTest, IClassFixture<TrainOneValidModelWithSuccessOptimizationFixture>
    {
        private Guid FolderId { get; set; }

        public TrainOneValidModelWithSuccessOptimization(OsdrWebTestHarness fixture, ITestOutputHelper output, TrainOneValidModelWithSuccessOptimizationFixture initFixture) : base(fixture, output)
        {
