...
namespace Sds.Osdr.EndToEndTests
{
    public class InvalidRxnProcessingFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "empty.rxn", new Dictionary<string, object>() { { "parentId", harness.JohnId } }).Result;
    ...
    public class InvalidRnxProcessing : OsdrWebTest, IClassFixture<InvalidRxnProcessingFixture>
    {
        ...
        public InvalidRnxProcessing(OsdrTestHarness fixture, ITestOutputHelper output, InvalidRxnProcessingFixture initFixture) : base(fixture, output)
        {
