...
{
    public class ImageProcessingFixture
    {
    ...
    public class ImageProcessing : OsdrWebTest, IClassFixture<ImageProcessingFixture>
    {
        private Guid BlobId { get; set; }
        private Guid FileId { get; set; }

        public ImageProcessing(OsdrTestHarness fixture, ITestOutputHelper output, ImageProcessingFixture initFixture) : base(fixture, output)
        {
