...
namespace Sds.Osdr.IntegrationTests
{
    public class InvalidCifProcessingFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "1100110_modified.cif", new Dictionary<string, object>() { { "parentId", harness.JohnId } }).Result;
