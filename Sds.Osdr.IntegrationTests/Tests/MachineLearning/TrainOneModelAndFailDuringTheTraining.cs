...
namespace Sds.Osdr.IntegrationTests
{
    ...
    public class TrainOneModelAndFailDuringTheTraining : OsdrTest, IClassFixture<TrainOneModelAndFailDuringTheTrainingFixture>
    {
        ...
        [Fact
            ...
            , ProcessingTrait(TraitGroup.All, TraitGroup.MachineLearning)]
        ...
        {
            var models = Harness.GetDependentFiles(FolderId).ToList();
            ...
            var files = Harness.GetDependentFiles(modelId).ToList();
