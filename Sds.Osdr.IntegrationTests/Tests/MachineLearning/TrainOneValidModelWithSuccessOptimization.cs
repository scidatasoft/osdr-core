...
{
    public class TrainOneValidModelWithSuccessOptimizationFixture
    {
        public Guid FolderId { get; set; }

        public TrainOneValidModelWithSuccessOptimizationFixture(OsdrTestHarness harness)
        {
            //var blobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "combined lysomotrophic.sdf", new Dictionary<string, object>() { { "parentId", harness.JohnId }, { "case", "valid one model with success optimization" } }).Result;

            //var sdfFileId = harness.WaitWhileRecordsFileProcessed(blobId);
    ...
    public class TrainOneValidModelWithSuccessOptimization : OsdrTest, IClassFixture<TrainOneValidModelWithSuccessOptimizationFixture>
    {
        private Guid FolderId { get; set; }

        public TrainOneValidModelWithSuccessOptimization(OsdrTestHarness fixture, ITestOutputHelper output, TrainOneValidModelWithSuccessOptimizationFixture initFixture) : base(fixture, output)
        {
