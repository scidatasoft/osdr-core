...
namespace Sds.Osdr.IntegrationTests
{
    public class UploadOneModelFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "Bernoulli_Naive_Bayes_with_isotonic_class_weights.sav",
            ...
            ModelId = harness.WaitWhileModelUploaded(BlobId);
        }
    }
