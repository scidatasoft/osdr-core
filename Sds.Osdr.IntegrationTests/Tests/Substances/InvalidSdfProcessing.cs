...
namespace Sds.Osdr.IntegrationTests
{
    public class InvalidSdfProcessingFixture
    {
        ...
        {
            BlobId = harness.JohnBlobStorageClient.AddResource(harness.JohnId.ToString(), "invalid_sdf_with_20_records_where_first_and_second_are_invalid.sdf", new Dictionary<string, object>() { { "parentId", harness.JohnId } }).Result;
